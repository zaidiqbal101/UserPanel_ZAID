  ...
  return (
    <AdminLayout>
      <div className="p-6 bg-white shadow-md rounded-lg">
        <h1 className="text-xl font-bold mb-4">Fetch Beneficiary1 by Bene ID</h1>
        ...
        <form onSubmit={handleSubmit} className="mb-4">
          ...
          <label className="block text-gray-700 font-medium mt-3">Beneficiary ID:</label>
          <input
            type="text"
            value={data.beneid}
            onChange={(e) => setData("beneid", e.target.value)}
            required
            className="border rounded p-2 w-full mt-2"
        ...
        {submitted && (
          <div className="mt-4">
            <h3 className="text-lg font-semibold">Response for {enteredMobile} (Bene ID: {enteredBeneId}):</h3>
